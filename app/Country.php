...
{
    protected $table = 'countries'; //manual assign the table this model is associated with. usually no need if the model name is the singular of the table name.
    ...
    # Static Functions ---------------------------------------------------------------------------------------------->
  	...
  	{
  		$countries = Country::select('code', 'name')
  							->get();
  		return $countries;
  	}
}
