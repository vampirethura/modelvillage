                ...
                <div class="box-body">
                  <div class="form-horizontal">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" id="group" class="form-control" placeholder="Feature Group (Optional)" name="group" value="{{ old('group') }}">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" id="name" class="form-control" placeholder="Feature Name" name="name" value="{{ old('name') }}" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="module" class="col-sm-2 control-label">Module Name</label>
                      <div class="col-sm-10">
                        <input type="text" id="module" class="form-control" placeholder="Module Name (Must be unique)" name="module" value="{{ old('module') }}">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="descr" class="col-sm-2 control-label">Label</label>
                      <div class="col-sm-10">
                        <input type="text" id="descr" class="form-control" placeholder="Description" name="descr" value="{{ old('descr') }}" >
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" id="url" class="form-control" placeholder="Module URL" name="url" value="{{ old('url') }}">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 ui-sortable">
                          <label class="checkbox-inline">
                            ...
                            <input type="checkbox" name="display" value="1" class="minimal" checked>
                            Show
                          </label>
                          <label class="checkbox-inline">
                            <input name="admin" type="hidden" value="0">
                            <input type="checkbox" name="admin" value="1" class="minimal">
                            Admin
                          </label>
                          <label class="checkbox-inline">
                            <input name="crud" type="hidden" value="0">
                            <input type="checkbox" name="crud" value="1" class="minimal" checked>
                            CRUD
                          </label>
                      </div>
                    </div>
