...
<div class="content" name="{{$module}}">
  ...
  <section class="content">
    <div class="row">
      {!! Form::open(['url'=>'/crm/feature/'.$feature->id.'/permission', 'method'=>'POST', 'class'=>'form-horizontal']) !!}
      <div class="col-lg-12 col-md-12 col-sm-12">
        <!-- Horizontal Form -->
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Create Feature's Permission</h3>
          </div><!-- /.box-header -->
          <div class="box-body">
            <div class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" id="name" class="form-control" placeholder="Permission name should be lower case without space (eg: get_data)" name="name" value="{{ old('name') }}" required>
                </div>
              </div>
              <div class="form-group">
                <label for="label" class="col-sm-2 control-label">Label</label>
                <div class="col-sm-10">
                  <input type="text" id="label" class="form-control" placeholder="Label of permission" name="descr" value="{{ old('descr') }}">
                </div>
              </div>
              <div class="form-group">
                <label for="name" class="col-sm-2 control-label">Position</label>
                <div class="col-sm-10">
                  <input type="text" id="position" class="form-control" placeholder="Position to appear" name="position" value="{{ old('position') }}" autocomplete="off" required>
                </div>
              </div>
              <div class="form-group">
                <label for="url" class="col-sm-2 control-label">URL</label>
                <div class="col-sm-10">
                  <input type="text" id="url" class="form-control" placeholder="URL (eg: /crm/customer/get_data)" name="url" value="{{ old('url') }}" required>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" id="page" class="form-control" placeholder="Render's Page" name="page" value="{{ old('page') }}" autocomplete="off" required>
                </div>
              </div>
              <div class="form-group">
                <label for="prompt_type" class="col-sm-2 control-label">Prompt's Type</label>
                <div class="col-sm-10">
                  <input type="text" id="prompt_type" class="form-control" placeholder="Prompt Type" name="prompt_type" value="{{ old('prompt_type') }}" autocomplete="off" required>
                </div>
              </div>
              <div class="form-group">
                <label for="prompt_title" class="col-sm-2 control-label">Prompt's Title</label>
                <div class="col-sm-10">
                  <input type="text" id="prompt_title" class="form-control" placeholder="Leave blank if prompt type is none." name="prompt_title" value="{{ old('prompt_title') }}">
                </div>
              </div>
              <div class="form-group">
                <label for="prompt_content" class="col-sm-2 control-label">Prompt's Content</label>
                <div class="col-sm-10">
                  <input type="text" id="prompt_content" class="form-control" placeholder="Leave blank if prompt type is none." name="prompt_content" value="{{ old('prompt_content') }}">
                </div>
              </div>
            </div>
          </div><!-- /.box-body -->
